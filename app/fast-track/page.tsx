...
export default function FastTrackPage() {
  const content = `
    <div style="max-width: 4xl; margin: 0 auto; padding: 2rem 1rem;">
      <div style="background: rgba(46, 170, 220, 0.08); border-left: 4px solid rgba(46, 170, 220, 0.3); padding: 1rem; margin-bottom: 2rem; border-radius: 4px;">
        <h3 style="margin-top: 0; color: rgb(55, 53, 47);">Overview</h3>
      ...
      <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 1rem; margin-bottom: 2rem;">
        <div style="border: 1px solid rgba(55, 53, 47, 0.09); padding: 1.5rem; border-radius: 8px; background: rgba(55, 53, 47, 0.02);">
          <div style="font-size: 2rem; margin-bottom: 0.5rem;">⏰</div>
          <strong>Limited Time</strong>
          <p style="margin-top: 0.5rem; color: rgba(55, 53, 47, 0.65); font-size: 0.9rem;">Need to prep for interviews quickly</p>
        </div>
        <div style="border: 1px solid rgba(55, 53, 47, 0.09); padding: 1.5rem; border-radius: 8px; background: rgba(55, 53, 47, 0.02);">
          <div style="font-size: 2rem; margin-bottom: 0.5rem;">🎯</div>
          <strong>High-Impact Focus</strong>
          <p style="margin-top: 0.5rem; color: rgba(55, 53, 47, 0.65); font-size: 0.9rem;">Want to learn most important topics first</p>
        </div>
        <div style="border: 1px solid rgba(55, 53, 47, 0.09); padding: 1.5rem; border-radius: 8px; background: rgba(55, 53, 47, 0.02);">
          <div style="font-size: 2rem; margin-bottom: 0.5rem;">📚</div>
          <strong>Structured Learning</strong>
          <p style="margin-top: 0.5rem; color: rgba(55, 53, 47, 0.65); font-size: 0.9rem;">Prefer template-based approach</p>
        </div>
      </div>

      <h2>Learning Principles</h2>
      <div style="background: rgba(46, 170, 220, 0.08); border-left: 4px solid rgba(46, 170, 220, 0.3); padding: 1rem; margin-bottom: 1rem; border-radius: 4px;">
        <h3 style="margin-top: 0; color: rgb(55, 53, 47);">Three Core Principles</h3>
      ...
      <div style="background: rgba(251, 243, 219, 0.6); border-left: 4px solid rgba(233, 196, 106, 0.4); padding: 1rem; margin-bottom: 2rem; border-radius: 4px;">
      ...
      <p><span style="background: rgba(55, 53, 47, 0.08); color: rgb(55, 53, 47); padding: 0.25rem 0.5rem; border-radius: 4px; font-size: 0.875rem; font-weight: 600;">Beginner</span> <em>2 days</em></p>
      <ul>
      ...
      <h3>Hash Tables</h3>
      <p><span style="background: rgba(55, 53, 47, 0.08); color: rgb(55, 53, 47); padding: 0.25rem 0.5rem; border-radius: 4px; font-size: 0.875rem; font-weight: 600;">Beginner</span> <em>1-2 days</em></p>
      ...
      <h3>Binary Trees ⭐</h3>
      <p><span style="background: rgba(235, 87, 87, 0.1); color: rgb(235, 87, 87); padding: 0.25rem 0.5rem; border-radius: 4px; font-size: 0.875rem; font-weight: 600;">Critical Foundation</span> <em>2-3 days</em></p>
      <div style="background: rgba(251, 243, 219, 0.6); border-left: 4px solid rgba(233, 196, 106, 0.4); padding: 1rem; margin: 1rem 0; border-radius: 4px;">
      ...
      <p><span style="background: rgba(55, 53, 47, 0.08); color: rgb(55, 53, 47); padding: 0.25rem 0.5rem; border-radius: 4px; font-size: 0.875rem; font-weight: 600;">Beginner</span> <em>1 day</em></p>
      <p><strong>Core Concepts:</strong></p>
      <ul>
      ...
      <h3>Binary Heap</h3>
      <p><span style="background: rgba(55, 53, 47, 0.08); color: rgb(55, 53, 47); padding: 0.25rem 0.5rem; border-radius: 4px; font-size: 0.875rem; font-weight: 600;">Beginner</span> <em>0.5 days</em></p>
      <p><strong>Core Concepts:</strong></p>
      <ul>
      ...
      <p><span style="background: rgba(235, 87, 87, 0.1); color: rgb(235, 87, 87); padding: 0.25rem 0.5rem; border-radius: 4px; font-size: 0.875rem; font-weight: 600;">Must Read</span> <em>0.5 days</em></p>
      <div style="background: rgba(46, 170, 220, 0.08); border-left: 4px solid rgba(46, 170, 220, 0.3); padding: 1rem; margin: 1rem 0; border-radius: 4px;">
      ...
      <h3>Linked Lists</h3>
      <p><span style="background: rgba(46, 170, 220, 0.1); color: rgb(46, 170, 220); padding: 0.25rem 0.5rem; border-radius: 4px; font-size: 0.875rem; font-weight: 600;">Intermediate</span> <em>2 days</em></p>
      <ul>
      ...
      <h3>Arrays</h3>
      <p><span style="background: rgba(46, 170, 220, 0.1); color: rgb(46, 170, 220); padding: 0.25rem 0.5rem; border-radius: 4px; font-size: 0.875rem; font-weight: 600;">Intermediate</span> <em>3-5 days</em></p>
      ...
      <h3>Stack & Queue</h3>
      <p><span style="background: rgba(46, 170, 220, 0.1); color: rgb(46, 170, 220); padding: 0.25rem 0.5rem; border-radius: 4px; font-size: 0.875rem; font-weight: 600;">Intermediate</span> <em>2-4 days</em></p>
      <ul>
      ...
      <p><span style="background: rgba(235, 87, 87, 0.1); color: rgb(235, 87, 87); padding: 0.25rem 0.5rem; border-radius: 4px; font-size: 0.875rem; font-weight: 600;">Critical Section</span> <em>5-7 days</em></p>
      <div style="background: rgba(235, 87, 87, 0.08); border-left: 4px solid rgba(235, 87, 87, 0.3); padding: 1rem; margin: 1rem 0; border-radius: 4px;">
      ...
      <p><span style="background: rgba(46, 170, 220, 0.1); color: rgb(46, 170, 220); padding: 0.25rem 0.5rem; border-radius: 4px; font-size: 0.875rem; font-weight: 600;">Intermediate</span> <em>2-3 days</em></p>
      <ul>
      ...
      <p><span style="background: rgba(46, 170, 220, 0.1); color: rgb(46, 170, 220); padding: 0.25rem 0.5rem; border-radius: 4px; font-size: 0.875rem; font-weight: 600;">Intermediate</span> <em>3-4 days</em></p>
      ...
      <p><span style="background: rgba(147, 51, 234, 0.1); color: rgb(147, 51, 234); padding: 0.25rem 0.5rem; border-radius: 4px; font-size: 0.875rem; font-weight: 600;">Advanced</span> <em>5-7 days</em></p>
      <div style="background: rgba(46, 170, 220, 0.08); border-left: 4px solid rgba(46, 170, 220, 0.3); padding: 1rem; margin: 1rem 0; border-radius: 4px;">
      ...
      <h3>BFS Algorithm</h3>
      <p><span style="background: rgba(46, 170, 220, 0.1); color: rgb(46, 170, 220); padding: 0.25rem 0.5rem; border-radius: 4px; font-size: 0.875rem; font-weight: 600;">Intermediate</span> <em>3 days</em></p>
      <div style="background: rgba(46, 170, 220, 0.08); border-left: 4px solid rgba(46, 170, 220, 0.3); padding: 1rem; margin: 1rem 0; border-radius: 4px;">
      ...
      <p><span style="background: rgba(147, 51, 234, 0.1); color: rgb(147, 51, 234); padding: 0.25rem 0.5rem; border-radius: 4px; font-size: 0.875rem; font-weight: 600;">Advanced</span> <em>6-8 days</em></p>
      <div style="background: rgba(46, 170, 220, 0.08); border-left: 4px solid rgba(46, 170, 220, 0.3); padding: 1rem; margin: 1rem 0; border-radius: 4px;">
      ...
      <p><span style="background: rgba(46, 170, 220, 0.1); color: rgb(46, 170, 220); padding: 0.25rem 0.5rem; border-radius: 4px; font-size: 0.875rem; font-weight: 600;">Intermediate</span> <em>1 day</em></p>
      <div style="background: rgba(251, 243, 219, 0.6); border-left: 4px solid rgba(233, 196, 106, 0.4); padding: 1rem; margin: 1rem 0; border-radius: 4px;">
      ...
      <p><span style="background: rgba(147, 51, 234, 0.1); color: rgb(147, 51, 234); padding: 0.25rem 0.5rem; border-radius: 4px; font-size: 0.875rem; font-weight: 600;">Advanced</span> <em>2-4 days</em></p>
      ...
      <p><span style="background: rgba(55, 53, 47, 0.08); color: rgb(55, 53, 47); padding: 0.25rem 0.5rem; border-radius: 4px; font-size: 0.875rem; font-weight: 600;">Beginner</span> <em>1 day</em></p>
      <div style="background: rgba(55, 53, 47, 0.03); border-left: 4px solid rgba(55, 53, 47, 0.16); padding: 1rem; margin: 1rem 0; border-radius: 4px;">
      ...
      <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 1rem; margin-bottom: 2rem;">
        <div style="border: 1px solid rgba(55, 53, 47, 0.09); padding: 1.5rem; border-radius: 8px; background: rgba(55, 53, 47, 0.02);">
          ...
          <ul style="margin-top: 0.5rem; padding-left: 1.5rem; font-size: 0.9rem; color: rgba(55, 53, 47, 0.65);">
        ...
        <div style="border: 1px solid rgba(55, 53, 47, 0.09); padding: 1.5rem; border-radius: 8px; background: rgba(55, 53, 47, 0.02);">
          ...
          <p style="margin-top: 0.5rem; font-size: 0.9rem; color: rgba(55, 53, 47, 0.65);"><strong>Use Them For:</strong></p>
          <ul style="margin-top: 0.5rem; padding-left: 1.5rem; font-size: 0.9rem; color: rgba(55, 53, 47, 0.65);">
            <li>Understanding company-specific patterns</li>
            <li>Review after mastering templates</li>
          </ul>
          <p style="margin-top: 0.5rem; font-size: 0.9rem; color: rgba(55, 53, 47, 0.65);"><strong>Don't:</strong> Skip templates to only practice company lists</p>
        </div>
        <div style="border: 1px solid rgba(55, 53, 47, 0.09); padding: 1.5rem; border-radius: 8px; background: rgba(55, 53, 47, 0.02);">
          <div style="font-size: 2rem; margin-bottom: 0.5rem;">🤔</div>
          <strong>When Stuck</strong>
          <ol style="margin-top: 0.5rem; padding-left: 1.5rem; font-size: 0.9rem; color: rgba(55, 53, 47, 0.65);">
        ...
        <div style="border: 1px solid rgba(55, 53, 47, 0.09); padding: 1.5rem; border-radius: 8px; background: rgba(55, 53, 47, 0.02);">
          ...
          <p style="margin-top: 0.5rem; font-size: 0.9rem; color: rgba(55, 53, 47, 0.65);">Use the visual roadmap to:</p>
          <ul style="margin-top: 0.5rem; padding-left: 1.5rem; font-size: 0.9rem; color: rgba(55, 53, 47, 0.65);">
      ...
      <div style="background: rgba(46, 170, 220, 0.08); border-left: 4px solid rgba(46, 170, 220, 0.3); padding: 1rem; margin-bottom: 2rem; border-radius: 4px;">
        <h3 style="margin-top: 0; color: rgb(55, 53, 47);">After Completing This Plan</h3>
      ...
      <div style="background: rgba(251, 243, 219, 0.6); border-left: 4px solid rgba(233, 196, 106, 0.4); padding: 1rem; margin-top: 2rem; border-radius: 4px;">
