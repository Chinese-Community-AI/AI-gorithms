...
const TipCard = ({
  ...
  <div className="border border-[#37352f]/10 dark:border-gray-800 rounded-lg p-5 bg-white dark:bg-[#191919] shadow-sm text-left hover:border-[#d9730d]/30 transition-all h-full">
